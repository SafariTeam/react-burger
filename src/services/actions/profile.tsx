...
export const register = (user: TUser) => (dispatch: AppDispatch) => {
...
export const RestorePassword = (email: string) => (dispatch: AppDispatch) => {
...
export const UpdatePassword = (restorationData: { password: string, token: string }) => (dispatch: AppDispatch) => {
...
export const AuthUser = (userdata: TUser) => (dispatch: AppDispatch) => {
...
export const RequestUser = () => (dispatch: AppDispatch) => {
  UpdateToken();
...
export const UpdateUser = (user: TUser) => (dispatch: AppDispatch) => {
  UpdateToken();
  const body = { ...user };
  const data = {
    method: "PATCH",
